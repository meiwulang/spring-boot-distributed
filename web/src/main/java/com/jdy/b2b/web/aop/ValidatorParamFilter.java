 ...
 */
@WebFilter(filterName = "requestTokenValidator", urlPatterns = "/fingercrm/*,/user/singlePointLoginValidateSuccess", dispatcherTypes = DispatcherType.REQUEST)
public class ValidatorParamFilter implements Filter {
    ...
    public void writeResult2Response(HttpServletResponse response) {
        ...
        logger.error("sorry ! error token~ ########  校验出错!!!");
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if ("GET".equalsIgnoreCase(method)) {
            ...
            result = ComparingToken(time, token, paramNames, parameterMap);
        } else {
            Map<String, String[]> parameterMap = request.getParameterMap();
