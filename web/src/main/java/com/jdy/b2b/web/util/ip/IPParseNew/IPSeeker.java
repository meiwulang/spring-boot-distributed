...
public class IPSeeker {  
   ...
   // Logger logger = Logger.getLogger(IPSeeker.class);  
    ...
    //private Integer ipCacheSize = 1000000;
    ...
    public IPLocation getIPLocation(String ip) {  
        ...
        return getIPLocation(ipByte);
            
           /* if (ipCache.size() > ipCacheSize) {
            	String old = ipCache.keySet().iterator().next();
            	ipCache.remove(old);
     ...
     * @return 
     */  
    public IPLocation getIPAdress(String ip){  
