 ...
 */
@ApiModel
public class UserSaveVo extends BaseVO implements Serializable{
    ...
    @ApiModelProperty(value = "自动生成员工编号",hidden = true)
    private String uNo;
    ...
    @Min(value=0,message = "用户销售类型最小为0")
    @Max(value=3,message = "用户销售类型最大为3")
