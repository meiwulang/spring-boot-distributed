...
public class WXUserResultDO implements Serializable{
    private static final long serialVersionUID = -2359152468901932798L;
    ...
    private Map<String,Object> u_setup = new HashMap<String,Object>();

    private String u_face;//暂无
    ...
    public Map<String, Object> getU_setup() {

        this.u_setup.put("pageSize ",20);
        return u_setup;
    }

    public void setU_setup(Map<String, Object> u_setup) {
        this.u_setup = u_setup;
    }
