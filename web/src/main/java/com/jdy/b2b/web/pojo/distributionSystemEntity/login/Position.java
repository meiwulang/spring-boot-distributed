...
public class Position implements Serializable {
	private static final long serialVersionUID = 3206977221201711183L;
	...
	public String toString() {
		return "Position {\"cloudId\":\"" + cloudId + "\", \"positionId\":\""
				+ positionId + "\", \"deptId\":\"" + deptId
				+ "\", \"positionCode\":\"" + positionCode
				+ "\", \"positionName\":\"" + positionName
				+ "\", \"positionDesc\":\"" + positionDesc
				+ "\", \"isActive\":\"" + isActive + "\", \"isDeleted\":\""
				+ isDeleted + "\", \"updateDt\":\"" + updateDt
				+ "\", \"createDt\":\"" + createDt + "\", \"creatorId\":\""
				+ creatorId + "\", \"updaterId\":\"" + updaterId
				+ "\", \"fPositionId\":\"" + fPositionId
				+ "\", \"fPositionName\":\"" + fPositionName
				+ "\", \"isManager\":\"" + isManager
				+ "\", \"positionLevel\":\"" + positionLevel
				+ "\", \"authType\":\"" + authType + "\", \"deptName\":\""
				+ deptName + "\", \"childPosition\":\"" + childPosition
				+ "\", \"startDt\":\"" + startDt + "\", \"endDt\":\"" + endDt
				+ "\", \"roleId\":\"" + roleId + "\", \"employeeId\":\""
				+ employeeId + "\", \"roleName\":\"" + roleName
				+ "\", \"roleDesc\":\"" + roleDesc + "\", \"roleStatus\":\""
				+ roleStatus + "\", \"employeeName\":\"" + employeeName
				+ "\", \"positionIdList\":\"" + positionIdList
				+ "\", \"roleIdList\":\"" + roleIdList
				+ "\", \"employeeIdList\":\"" + employeeIdList
				+ "\", \"children\":\"" + children + "\", \"tokenId\":\""
				+ tokenId + "\", \"positionHNo\":\"" + positionHNo
				+ "\", \"orgId\":\"" + orgId + "\", \"orgHNo\":\"" + orgHNo
				+ "\", \"isMainPosition\":\"" + isMainPosition
				+ "\", \"firstLetter\":\"" + firstLetter + "\", \"select\":\""
				+ select + "\", \"positionType\":\"" + positionType
