...
import com.jdy.b2b.web.util.wechat.wxpay.sdk.WXPayConstants.SignType;
...
//        }
    ...
    public String generateSignature(Map<String, String> reqData, String type) throws Exception{
        reqData.put("appId", config.getAppID());
        if(Objects.equals(type, "MD5")) {
            return WXPayUtil.generateSignature(reqData, config.getKey(), SignType.MD5);
        }
        return WXPayUtil.generateSignature(reqData, config.getKey(), SignType.HMACSHA256);
    }
