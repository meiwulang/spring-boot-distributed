      ...
      <div class="ticketprice clearfix border relative">
        ...
        <div class="jdy-table p10">
          <el-table :data="tableData" border class=" all" highlight-current-row @row-click="rowclickHandler">
            ...
            <el-table-column label="班期编号" min-width="100">
...
export default {
  ...
  methods: {
    ...
    editBanqi(id) {
      ...
      this.$router.push({ name: 'declareConfigEditSchedule', query: { id: this.search.sProductId, banqi: id,c_id:this.$route.query.c_id } })
    },
    editSeat(id) {   //清除自定义票价
    ...
    addBanqi(value) {    //添加班期
      this.$router.push({ name: 'declareConfigAddSchedule', query: { id: this.search.sProductId, type: value,c_id:this.$route.query.c_id } })
    },
