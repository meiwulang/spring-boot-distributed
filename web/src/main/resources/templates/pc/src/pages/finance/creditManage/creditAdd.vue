<template>
    <div class="jl-information">
        ...
        <div class="jdy-content-inner">
          <el-row class="search-row">
            <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" class="mt10">
              <el-row>
                <el-checkbox v-model="checked" class="inlineblock mr10 ">只关注杭州</el-checkbox>
                <el-form-item label="大区：" prop="type">
                ...
                <el-form-item label="快速搜索：" prop="quickSearch">
                  <el-input placeholder="分销商名称/编号/法人名称/手机号码" @change="searchKeyWords" v-model="searchValue" class="search-input-l">
                  </el-input>
                </el-form-item>
          ...
          <div class="jdy-table pt10">
            <el-table :data="tableData" style="width: 100%"  border>
              ...
              <el-table-column label="编号" prop="ticketType" width="340"></el-table-column>
              <el-table-column label="单位名称" prop="ticketPrice"  width="340"></el-table-column>
              <el-table-column label="分销商区域" prop="ticketNum" width="340"></el-table-column>
              <el-table-column label="法人代表" prop="bedNum" min-width="90"></el-table-column>
              <el-table-column label="手机号码" prop="stock" min-width="100"></el-table-column>
              <el-table-column label="联系电话 " prop="ticketPrice" min-width="100"></el-table-column>
              <el-table-column label="地址 " prop="ticketPrice" min-width="90"></el-table-column>
              <el-table-column label="操作" prop="ticketPrice"  min-width="70">
                <template scope="scope">
                  <el-button @click="setCreditFn(scope.row.id)" class="td-btn">授信</el-button>
                </template>
              </el-table-column>
            </el-table>
            <!-- 分页   begin-->
      ...
      <!-- 授信 弹窗 begin-->
      <jdy-alert title="授信设置" @closeAlert="closeAlert" v-if="alertCreditFlag" class="dialog-lv dialog-credit">
        ...
        <el-row class="btn-wrap fixed-foot">
