    ...
    <div class="jdy-content jdy-resources fleft jl-trip jl-pic">
        <div class="jdy-content-inner-trip">
            <div class="tripbox-tab clearfix">
                <a href="javascript:;" title="" class="relative inlineblock fleft" @click="goHotelInfo($route.query.type)">酒店基本信息
            ...
            <!--<el-form :model="ruleform" :rules="rules" ref="ruleform" class="demo-form" label-width="150px">
                            <el-row class="mt20 pl10 pr30">
                                <el-upload class="upload-demo"
                                    ...
                                    <el-button size="small" type="default" @click="delGroup">批量删除</el-button>
                                    <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
                                </el-upload>

                                <el-button @click="delGroup">批量删除</el-button>
                            </el-row>
                        </el-form> -->
            <div class="jdy-content-inner-trip">
