            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="对号入座:" prop="">
                  <el-select v-model="banqiForm.sSitType" placeholder="请选择" class="all"  @change='changeType'>
                ...
                <el-table-column label="调整车辆数" width="200" align="center">
                  <template scope="scope">
                    <el-row class="pb10">
                      ...
                      <el-col :span="4">
                        <el-button class=" ml10 carboxss-button mt10" @click="addCar" :disabled="canNotModifyCarNum">
                    ...
                    <el-row class="pb10">
                      <el-col :span="18">
                        ...
                        <el-form-item label="新座位数:" prop="">
                          <el-input-number :disabled="currentCar==-1" v-model.number="currentCar==-1?null:currentCarSeatNum" placeholder="请选择车辆" @change="seatChange" style="width: 100%;"></el-input-number>
                        </el-form-item>
                      </el-col>
                      <el-col :span="6">
                        <div class="border caredit1 tc" @click="modifyCarSeatNum">
