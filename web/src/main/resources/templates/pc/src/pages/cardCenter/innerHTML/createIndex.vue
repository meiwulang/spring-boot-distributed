...
<script>
  export default {
    ...
    mounted() {
      ...
      // this.srczj=inner_url+"sn-manage.html#/app/sn-list?uid="+logindata.userId;
      this.srczj=cardHostUrl+"shp-card-web/user/userAuth?uid="+logindata.userId+"&redirect="+cardRedirectUrl+"sn-manage.html#/app/sn-list";
    },
    methods: {
