			...
			<div class="resources-tab">
				<div class="fright">
                    <!-- <el-button type="primary"> -->
						<router-link class="routerbtn" :to="{ name: 'assemblyAddCostPage',query: {type: 0,pid:pid,isNull:isNull,c_id:c_id}}" v-if="locationFlag=='assemblylist'">
							<span>添加成本</span>
						</router-link>
						<router-link class="routerbtn" :to="{ name: 'addCostPage',query: {type: 0,pid:pid,isNull:isNull,c_id:c_id}}" v-if="locationFlag!='assemblylist'">
							<span>添加成本</span>
						</router-link>						
					<!-- </el-button> -->
				</div>
