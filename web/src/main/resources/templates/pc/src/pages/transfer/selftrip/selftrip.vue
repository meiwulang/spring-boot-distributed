      ...
      <el-row class="jdy-content-inner-trip border p15 pl25">
        <el-col :span="16">
          <div class="jdy-content-trip">
            <el-steps :center="true" :align-center="true" :active="2">
        ...
        <el-col :span="8">
          ...
          <el-button class="fright mt10" @click="goback('Line')">上一步</el-button>
          <el-button @click="onSubmit('ruleForm')" class="fright mt10" :disabled="btnFlag">保存</el-button>
        </el-col>
      </el-row>
          ...
          <div class="tripbox-top">
            <el-col :span="12" class="mt10" style="margin-left:-30px;">
              <el-form-item label="行程天数:">
                <el-input-number v-model="ruleForm.pDays" class="all" @change="setDays" :min="1"></el-input-number>
              ...
              <el-row>
                <el-col :span="16">
                  <el-form-item label="住宿情况：" prop="accommodation">
                    <div>
                      <el-select v-model="tripsItem.phHotelIds" multiple filterable no-data-text="请输入进行搜索" placeholder="请输入酒店名称，拼音码" :filter-method="getChangeLive" @change="pushHotelIds" style="width: 100%">
                ...
                <el-col :span="2">
                  <el-button class="btnbg fr" @click="UniteBtn(tripsItem.phHotelIds,tripsItem.hotel,tripsItem.tHotelRemark)" style="margin-left:10px;">同步住宿信息</el-button>
                </el-col>
              </el-row>
              <el-row>
