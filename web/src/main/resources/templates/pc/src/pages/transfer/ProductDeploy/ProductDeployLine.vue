          ...
          <el-col>
            <el-row>
                <el-form-item prop="cover" label="上传封面：">
                  <el-upload class="upload-demo" :disabled='true' drag :multiple="false" :action='imgUploadPath' :before-upload="checkFileType" :data="fileType" :on-success="uploadSuccess" :show-file-list="false" :on-error="uploadError" :headers="uploadHeader" :with-credentials=true>
            ...
            <el-row>
               <el-form-item label="产品来源：" prop="pFrom" v-if="lineForm.pFrom == 0 || lineForm.pFrom == 2 || lineForm.pFrom == 3 || lineForm.pFrom == 4">
                <el-select v-model="lineForm.pFrom" class="all" clearable :disabled='true'>
              ...
              <el-col :span="12">
                <el-form-item label="单位名称：" prop="pFromName" v-if="lineForm.pFrom == 1">
                  <el-input v-model="lineForm.pFromName" placeholder="请输入供应商单位名称" :disabled='true'></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              ...
              <el-col :span="3">
                <el-form-item label="目的地：" class="redstar">
                  <el-select v-model="lineForm.pDestinationLocation" clearable class="all" @change="changeCountry" :disabled='true'>
              ...
              <el-col :span="3">
                <el-form-item label-width="20px">
                  <el-select v-model="lineForm.pDestinationRegion" clearable placeholder="请选择省份" class="all" @change="provinceChange" :disabled='true'>
              ...
              <el-col :span="3">
                <el-form-item label-width="20px">
                  <el-select v-model="lineForm.pDestinationArea" clearable placeholder="请选择城市" class="all" :disabled='true'>
              ...
              <el-col :span="3">
                <el-form-item label-width="20px">
                  <el-input data="pDestination" v-model="lineForm.pDestination" placeholder="目的地" :disabled='true'></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="所属品牌：" prop="pBrand" placeholder="请选择所属品牌">
                  <el-select v-model="lineForm.pBrand" class="all" :filterable="true" :remote-method="searchBrand" clearable remote :disabled='true'>
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="联系人：" prop="pContacts">
                  <el-select v-model="lineForm.pContacts" :disabled='true'  class="all" :filterable="true" :remote-method="searchContacts" clearable remote @change="testChange123">
              ...
              <el-col :span="6">
                <el-form-item label="联系人英文" prop="pContactsEn">
                  <el-input v-model="lineForm.pContactsEn" placeholder="请填写联系人英文" :disabled='true'></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="产品排序：">
                  <el-input-number v-model="lineForm.pSort" type="number" :disabled='true' placeholder="产品排序" :min=0 :max="1000000" :controls="false" style="width: 100%;"></el-input-number>
                </el-form-item>
              </el-col>
              <el-col :span="12">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="主题：" prop="pTopicCn">
                  <el-input v-model="lineForm.pTopicCn" placeholder="请填写主题" :disabled='true'></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="英文主题：" prop="pTopicEn">
                  <el-input v-model="lineForm.pTopicEn" placeholder="请填写英文主题" :disabled='true'></el-input>
                </el-form-item>
              </el-col>                                   
            </el-row> 
            <el-row>
              <el-col :span="6">
                <el-form-item label="创意总监：" prop="pCreativeOfficerCn">
                  <el-input v-model="lineForm.pCreativeOfficerCn" placeholder="请填写创意总监" :disabled='true'></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="总监英文：" prop="pCreativeOfficerEn">
                  <el-input v-model="lineForm.pCreativeOfficerEn" placeholder="请填写创意总监英文" :disabled='true'></el-input>
                </el-form-item>
              </el-col>                                                
            </el-row>                         
            <el-row>
              <el-col :span="12">
                <el-form-item label="支付类型：">
                  <el-col :span="10">
                    <el-radio-group v-model="lineForm.pPayWay" :disabled='true'>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="产品归属：">
                  <el-col :span="10">
                    <el-radio-group v-model="lineForm.ascription" :disabled='true'>
        ...
        <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="生命周期：">
                  <el-col :span="10">
                    <el-date-picker v-model="datePicker" type="daterange" placeholder="选择日期范围" @change="dateRangeChange" :disabled='true'>
                    </el-date-picker>
                  </el-col>
                </el-form-item>
              </el-col>
