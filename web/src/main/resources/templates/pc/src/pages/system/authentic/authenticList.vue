      ...
      <div class="newuserList mt30">
          ...
          <div class="fleft userList clearfix">
            <div class="jdy-tab" style="margin:0;padding-right:0">
                ...
                <a href="javascript:;" title="" @click="jdytab(0)" :class="{ active: jdytabActive==0 }">待分配权限
                    <span></span>
                </a>
                <a href="javascript:;" title="" @click="jdytab(1)" :class="{ active: jdytabActive==1 }">已分配权限
                    <span></span>
                </a>
            </div>
            <div style="padding:1%">
                <el-input v-model.trim="tickForm.fastSearchStr" placeholder="请输入用户名，姓名，手机号" class="searchInput"></el-input>
                <el-button @click="getTableData(123)" type="primary" class="mr20 mt10">搜索</el-button>
            </div>
            ...
            <el-table-column label="操作" prop="" min-width="120">
                ...
                <el-button type="default" size="mini" @click.native.prevent="editdetail(scope.row.userId)">
                    编辑权限
                </el-button>
                </template>
            </el-table-column>
  ...
  export default {
    ...
    methods: {
        ...
        jdytab(index){
            ...
            this.tickForm.type=index===null?null:index;
        ...
        editdetail(id){
            this.$router.push({name:'authenticEdit',query:{id:id}})
        },
        detail(id){
            this.$router.push({name:'authenticDetail',query:{id:id}})
        },
      handleNodeClick(data){
        ...
        console.log(this.activeNode.parentId);
