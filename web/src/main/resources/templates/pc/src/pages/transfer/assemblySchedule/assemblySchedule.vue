  ...
  <div class="jdy-content jdy-transfer fleft noborder jl-schedule jl-information">
    <div class="jdy-content-inner-trip">
      <el-row class="jdy-content-inner-trip border p15 pl25">
        ...
        <el-col :span="8">
          <el-button class="fright mt10" @click="goback('assemblylist')">返回</el-button>
          <el-button type="primary" @click="upJia" class="fright mr10 mt10" v-show="showstatue!=0">入库</el-button>
          <a :href="h5Url" target="_blank"><el-button class="fright mt10 mr10 ml10" @click="gotoH5()">预览</el-button></a>
          <el-button class="fright mt10" @click="goLast('assemblyTicketprice')">上一步</el-button>
        </el-col>
      </el-row>
      ...
      <div class="ticketprice clearfix border relative">
        ...
        <div class=" p10">
          ...
          <div class="fright">
            ...
            <el-button type="default" class="btnbg mr25" @click="alertJournal">日志</el-button>
          </div>
        </div>
          ...
          <el-table :data="tableData" border class=" all" highlight-current-row @row-click="rowclickHandler">
            ...
            <el-table-column label="状态" width="">
              <template scope="scope">
                ...
                <el-tag closeTransition type="success" v-if="scope.row.sStatus === 0">正常</el-tag>
                <el-tag closeTransition type="danger" v-if="scope.row.sStatus === 1">暂停</el-tag>
                <!-- <el-switch v-else v-model="scope.row.sStatus" :on-value="0" :off-value="1" @click.native="getRowId(scope.row.id)" @change="changeStatus" on-color="#71dc1c" on-text="正常" off-text="暂停" disabled>
                </el-switch> -->
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    editBanqi(id) {
      ...
      this.$router.push({ name: 'assemblyEditSchedule', query: { id: this.search.sProductId, banqi: id } })
    },
    editSeat(id) {   //清除自定义票价
