...
window.index_url = api_prefix.index_url
window.inner_host = api_prefix.inner_host

window.cardHostUrl = api_prefix.cardHostUrl
window.cardRedirectUrl = api_prefix.cardRedirectUrl
