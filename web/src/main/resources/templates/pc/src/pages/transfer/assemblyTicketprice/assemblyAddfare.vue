        ...
        <div class="jdy-content-inner">
            <el-form :model="tickForm" :rules="rules" ref="tickForm" class="demo-form-inline" label-width="150px">
                <div class="jdy-tab">
                    ...
                    <el-button class="fright mt10" @click="goback('assemblyTicketprice')">返回</el-button>
                    <el-button type="primary" @click="onSubmit()" class="fright mt10 mr10" :disabled="btnFlag">保存</el-button>
                </div>
                <div class="tripbox clearfix border relative mt30" style="padding-top: 40px;">
                    <div class="clearfix p10">
                        <el-row>
                            <el-col :span="8">
                                <el-form-item label="票价类目:" prop="tCategory">
                                    <el-select v-model="tickForm.tCategory" class="inputGeneral" :disabled="true">
                            ...
                            <el-col :span="8">
                                <el-form-item label="票价类型:" prop="tType">
                                    <el-select v-model="tickForm.tType" @change="getName" class="inputGeneral" :disabled="true">
                            ...
                            <el-col :span="8">
                                <el-form-item label="票价名称:" prop="tName">
                                    <el-input v-model="tickForm.tName" class="inputGeneral" :disabled="true"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            ...
                            <el-col :span="8">
                                <el-form-item label="内部集结价:" prop="tMarketPrice" class="redstar">
                                    <el-input class="inputGeneral" v-model="tickForm.tGatherPrice" :disabled="true"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="库存量:" >
                                    <el-input-number v-model="tickForm.tStock" :min="-1" class="inputGeneral" :disabled="true"></el-input-number>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="成人数:" class="redstar">
                                     <el-input-number v-model="tickForm.tAdultNum" :min="0" class="inputGeneral" :disabled="true"></el-input-number>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="儿童数:" class="redstar">
                                     <el-input-number v-model="tickForm.tChildNum" :min="0" class="inputGeneral" :disabled="true"></el-input-number>
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="交通类目:" prop="tTraffic" >
                                    <el-select v-model="tickForm.tTraffic" @change="getStationList(false)" id="TrafficDiv" class="inputGeneral" :disabled="true">
                        ...
                        <el-row>
                            <el-form-item label="票价简介:">
                                <el-input v-model="tickForm.tIntroduction" type="textarea" :disabled="true"></el-input>
                            </el-form-item>
                        </el-row>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            if(valid){
                ...
                // else{
                //     console.log("正则",RegExObj.moneyTwoPoint.test(fare.tMarketPrice))
                //     // if(!RegExObj.moneyTwoPoint.test(fare.tMarketPrice)){
                //     //     console.log(123123)
                //     //     this.$message.error('门市价金钱数字格式不正确');
                //     //     return;
                //     // }
                //     console.log(parseFloat(fare.tMarketPrice).toFixed(2),fare.tMarketPrice)
                //     if( parseFloat(fare.tMarketPrice).toFixed(2) != fare.tMarketPrice  ) {
                //         this.$message.error('门市价金钱数字格式不正确');
                //         return false;
                //     }
                // }
                ...
                fare.fromProductListMenu=false;
                // 编辑、新增判断
                let urls="";
                if(this.$route.query.type==1){
                    urls='ticket/update'
                ...
                if(data.code == "0"){
                    ...
                    this.$router.push({ name: 'assemblyTicketprice',query:{id: this.$route.query.id}})
                }else{
                    this.btnFlag = false;
  ...
  mounted(){
    ...
    console.log("redstar:",$(".el-form-item.redstar .el-form-item__label").text())
  }
}
</script>
