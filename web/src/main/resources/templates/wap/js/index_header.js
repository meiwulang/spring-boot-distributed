...
if(_uinfo && _uinfo.u_id) {
	...
	var htmlu = "<div class='pull-right'><div class='pull-left'><span>欢迎您!</span><span class='hotsoso' id='user_name'>" + _uinfo.u_realname + "</span></div><span class='pull-left'>&nbsp;&nbsp;|&nbsp;&nbsp;</span><div class='pull-left'><span>" + _uinfo.org_sname + "</span> </div><span class='pull-left'>&nbsp;&nbsp;|&nbsp;&nbsp;</span><div class='pull-left'><a href='/index/main.shtml' target='_blank'>管理中心</a></div><span class='pull-left'>&nbsp;&nbsp;|&nbsp;&nbsp;</span><div class='pull-left'><a href='http://uat.help.jdytrip.cn' target='_blank'>帮助中心</a></div><span class='pull-left'>&nbsp;&nbsp;|&nbsp;&nbsp;</span><div class='pull-left'><a href='http://uat.app.jdytrip.cn' target='_blank'>应用市场</a></div><span class='pull-left'>&nbsp;&nbsp;|&nbsp;&nbsp;</span><div class='pull-left'><a href='logout.html'>安全退出</a></div></div>"
	if (window.location.host == "www.jdytrip.cn") {
		$(".my_navbar .pull-right").html(htmlw);
	}else if(window.location.host == "test.jdytrip.cn"){
		$(".my_navbar .pull-right").html(htmlu);
	}else{
	...
	if (window.location.host == "www.jdytrip.cn") {
		...
		$('.help').attr('href','http://uat.help.jdytrip.cn');
		$('.market').attr('href','http://uat.app.jdytrip.cn');
	}else{
...
// $('#message').load('message.html?v=1',function(){
...
if (!(_uinfo && _uinfo.u_id)) {
    $('.businessLink').attr('href','/index/login.shtml');
    $('.contactCustomer').hide();
}

function FloatHover() {
	$('.contactCustomer').hover(function() {
    	$('.floating').show();
    	$('.serverTel').find('i').addClass('fa-caret-up').removeClass('fa-caret-down');
    },function() {
    	$('.floating').hide();
    	$('.serverTel').find('i').removeClass('fa-caret-up').addClass('fa-caret-down');
    })
}
FloatHover();
