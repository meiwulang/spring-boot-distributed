	...
	$.extend(Plugin.prototype, {
		...
		_construct: function(){
			...
			this.$options.each(function(i, e){
				...
				o+='<li class="'+(this.disabled? self.settings.disabledClass : "option-item") + ' ' +(k == self.selectedIndex? self.settings.selectedClass : '')+ '" data-index="'+(k)+'" data-value="'+this.value+'" data-balance="'+$(this).attr('data-balance')+'">'+ (this.innerHTML) + '</li>'
