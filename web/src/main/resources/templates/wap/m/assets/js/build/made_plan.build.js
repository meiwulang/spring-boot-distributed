	...
	var Index = function () {
	  ...
	  (0, _createClass3.default)(Index, [{
	    ...
	    value: function Render(currpage) {
	      ...
	      var projectId = _global2.default.GetUrlPara('id');
	      var typeedit = _global2.default.GetUrlPara('type');
	      ...
	      _global2.default.Ajax({
	        ...
	        success: function success(res) {
	          if (res.code == 200) {
	            ...
	            var html = (0, _artTemplate2.default)('tpl-lists', res.body);
	    ...
	    key: 'Event',
	    value: function Event(Htid) {
	      var _this = this;
	      (0, _jquery2.default)(".plan_sure").on("click", function () {
	        _popup2.default.Info('是否确认方案？');
	        _this.Ht(Htid);
	      });
	    }
	  }, {
	    key: 'Ht',
	    value: function Ht(Htid) {
	      var html = '<div class="lesse">取消</div><div class="yer">确定</div>';

	      var imgHtml = '<div><p class="success-icon"></p><p>操作成功！</p></div>';
