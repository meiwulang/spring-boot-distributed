	    ...
	    function Index() {
	        ...
	        _global2.default.CheckLogin(function () {
	            _global2.default.GetCityCode(function (citycode, cityname) {
	                ...
	                (0, _jquery2.default)('.card-a').on('click', function () {
	    ...
	    (0, _createClass3.default)(Index, [{
	        ...
	        value: function UserInfo() {
	            if (!share_user || (0, _stringify2.default)(share_user) == '{}') {
	                (0, _jquery2.default)('.user-info').hide();
	            } else if (share_user.org_type != '供应商') {
	                var html = (0, _artTemplate2.default)('tpl-userinfo', share_user);
	                (0, _jquery2.default)('.user-info').html(html);
	            }
	        }
	    }, {
	        key: 'Banner',
	        value: function Banner() {
	            ...
	            _global2.default.Ajax({
	                ...
	                success: function success(res) {
	                    if (res.code == 200) {
	                        var html = (0, _artTemplate2.default)('tpl-banner', res);
	                        (0, _jquery2.default)('.swiper-wrapper').html(html);
	                        ...
	                        if (!res.data) {
	                            (0, _jquery2.default)('.banner').height(0);
	                        }
	                    }
	                }
	            });
	            ...
	            _global2.default.Ajax({
	                ...
	                success: function success(res) {
	                    if (res.code == 200) {
	                        ...
	                        res['openId'] = _global2.default.GetUrlPara('openId');
	                        var html = (0, _artTemplate2.default)('tpl-list', res);
	        ...
	        value: function Event() {
	            ...
	            (0, _jquery2.default)('h2.products-tit').on('click', function () {
	                (0, _jquery2.default)(this).toggleClass('eye-close');
	                (0, _jquery2.default)('.products li .return').toggle();
	                if ((0, _jquery2.default)(this).hasClass('eye-close')) {
