...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Index = function () {
		...
		(0, _createClass3.default)(Index, [{
			...
			value: function Even() {
				var _this = this;
				var imgout = _global2.default.GetUrlPara('imgout');
				if (imgout == '1') {
					(0, _jquery2.default)(".bear").hide();
				}
				if (_uinfo && _uinfo.u_id) {
					(0, _jquery2.default)(".yes").css("display", "block");
				} else {
					(0, _jquery2.default)(".nos").css("display", "block");
				}
				(0, _jquery2.default)(".che_detail").on("click", function () {
					var no = _global2.default.GetUrlPara('n');
					window.location.href = 'order_detail.html?n=' + no;
				});

				if ((0, _jquery2.default)(".bear img").hasClass("zf")) {
					(0, _jquery2.default)(document).attr("title", "支付成功");
				} else {
					(0, _jquery2.default)(document).attr("title", "预定成功");
				}
				(0, _jquery2.default)(".pay_list .choice").on("click", function () {
					(0, _jquery2.default)(".succ").addClass("active");
				...
				(0, _jquery2.default)(".succ").on("click", function () {
					if ((0, _jquery2.default)(".mation_pact .choice").hasClass("choice_yes")) {
						var _this2 = this;
						var no = _global2.default.GetUrlPara('n');
						_global2.default.Ajax({
				...
				(0, _jquery2.default)(".succ_cal").on("click", function () {
					window.history.back();
				});
			}
		}]);
