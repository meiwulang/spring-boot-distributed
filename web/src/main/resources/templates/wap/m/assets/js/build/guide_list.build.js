	...
	var Index = function () {
	  ...
	  (0, _createClass3.default)(Index, [{
	    ...
	    value: function Show(currpage) {
	      ...
	      if ((0, _jquery2.default)('.nol').hasClass("ba")) {
	        var own = '1';
	      } else {
	        var own = '0';
	      }
	      ...
	      _global2.default.Ajax({
	        ...
	        success: function success(res) {
	          ...
	          if (res.code == 200) {
	            ...
	            (0, _jquery2.default)('.main_t').append(html);
	    ...
	    value: function Event() {
	      ...
	      if (!(_uinfo && _uinfo.u_id)) {
	        (0, _jquery2.default)(".lef").css("display", "none");
	      } else {
	        (0, _jquery2.default)(".noly").css("display", "");
	      }
	      (0, _jquery2.default)("").off().change(function () {
	        if (_this.jax == 0) {
	          (0, _jquery2.default)('.main_t').html("");
	          _this.pages.count = 1;
	          _this.Show(_this.pages.count);
	        }
	      });
	      (0, _jquery2.default)(".noly").off().on("click", function () {
	        (0, _jquery2.default)(".nol").toggleClass("ba");
	        (0, _jquery2.default)('.main_t').html("");
	        _this.pages.count = 1;
	        _this.Show(_this.pages.count);
	      });
	        ...
	        if (scrollTop + windowHeight == scrollHeight) {
	          ...
	          if (_this.pages.total > _this.pages.count * 10) {
	            if (!(0, _jquery2.default)('body').hasClass('scrolling')) {
	              (0, _jquery2.default)(".main_t").append('<div class="loading" style="text-align:center; line-height:30px;">加载中...</div>');
	              _this.Show(++_this.pages.count);
	            }
	          } else {
	            (0, _jquery2.default)(".loading").remove();
