	...
	var Index = function () {
		function Index() {
			...
			_global2.default.CheckLogin(function () {
				...
				(0, _jquery2.default)(".main .links").on("click", function () {
					window.location.href = acard;
				});
				if (_uinfo && _uinfo.u_stype) {
					if (window.__wxjs_environment !== "miniprogram" && _uinfo.u_stype != '3') {
						(0, _jquery2.default)(".links").show();
					}
				}
				if (_uinfo && _uinfo.u_stype) {
					if (window.__wxjs_environment === "miniprogram" || _uinfo.u_stype == '3') {
						(0, _jquery2.default)(".t-bar .left").hide();
					}
				}
		...
		(0, _createClass3.default)(Index, [{
			...
			value: function Tab() {
				var _this = this;
				var ty = '';
				(0, _jquery2.default)('.infor-bar ul li').off().on('click', function () {
					sessionStorage.setItem("typ", (0, _jquery2.default)(this).attr("typ"));
					sessionStorage.setItem("typeNum", (0, _jquery2.default)(this).attr("typeNum"));
					(0, _jquery2.default)(this).find('a').addClass('active');
					(0, _jquery2.default)(this).siblings().find('a').removeClass('active');
					(0, _jquery2.default)('.lists').html("");
			...
			value: function Render(currpage) {
				...
				if (typeNum) {
					(0, _jquery2.default)(".infor-bar ul li").each(function () {
						if (typeNum == (0, _jquery2.default)(this).attr("typeNum")) {
							(0, _jquery2.default)(".infor-bar ul li a").removeClass('active');
							(0, _jquery2.default)(this).find("a").addClass('active');
						}
					});
				}
				var _this = this;
				var status = (0, _jquery2.default)('.infor-bar ul li a.active').attr('typeNum');
				...
				_global2.default.Ajax({
					...
					success: function success(res) {
						if (res.code == 200) {
							var _data = res.data.pageInfo;
							_this.pages.total = res.data.pageInfo.total;
							_data['order_type'] = order_type;
							var html = (0, _artTemplate2.default)('tpl-lists', _data);
							(0, _jquery2.default)(".loading").remove();
							(0, _jquery2.default)('.lists').append(html);
			...
			value: function Dele() {
				var _this = this;
				(0, _jquery2.default)(".delete").off().on("click", function () {
					var num = (0, _jquery2.default)(this).parents("li").attr("num"),
					    sta = (0, _jquery2.default)(this).parents("li").attr("status"),
					    prod = (0, _jquery2.default)(this).parents("li").attr("prod"),
					    orderid = (0, _jquery2.default)(this).parents("li").attr("ids"),
					    org_name = (0, _jquery2.default)(this).parents("li").attr("org_name"),
					    real = (0, _jquery2.default)(this).parents("li").attr("real");
					...
					var formPop = _popup2.default.Info(html);

					if (sta != '已全款') {
						(0, _jquery2.default)("#popup-info .pop_bg .wy_mon").attr("readonly", "readonly");
						(0, _jquery2.default)("#popup-info .pop_bg .wy_mon").css("background", "#f4f8f5");
					}
					(0, _jquery2.default)(".pop_bg .cancel").on("click", function () {
						_popup2.default.PopupRemove();
					});
					(0, _jquery2.default)(".spa").on("click", function () {
						(0, _jquery2.default)("#popup-info .pop_bg ul").toggleClass("spas");
					});
					(0, _jquery2.default)(".pop_bg .submit").off().on("click", function () {
						var tions = (0, _jquery2.default)(".tions").val();
						if (tions.length > 300) {
							_popup2.default.Tip('取消原因不能超过300字！');
						} else {
							formPop.hide();
							_this.Deles(num, sta, real, formPop, orderid);
						}
					});
					(0, _jquery2.default)(".wy_mon").on("input propertychange", function () {
						var tes = (0, _jquery2.default)(".wy_mon").val();
						if (tes < 0) {
							(0, _jquery2.default)(".wy_mon").val('0');
						} else {
							tes = tes.replace(/[^0-9]/ig, "");
							(0, _jquery2.default)(".wy_mon").val(tes);
						}
					});
				});
				(0, _jquery2.default)(".no_delete").on("click", function () {
					_popup2.default.Tip("你没有操作【取消订单】权限 订单确认后只能供应商可以操作取消！");
				});
				(0, _jquery2.default)(".deletes").on("click", function () {
					_popup2.default.Tip("当前订单”计划单已生成“不可取消订单 如需取消请从计划单中移除相应订单！");
				});
				//  跳转到退款申请页
				(0, _jquery2.default)(".refund").on("click", function () {
					var orderId = (0, _jquery2.default)(this).attr("oId");
					window.location.href = 'order_refundApply.html?id=' + orderId;
				});
				// 跳转到退款记录页
				(0, _jquery2.default)(".refundRecord").off().on("click", function (e) {
					e.stopPropagation();
					e.preventDefault();
					var orderId = (0, _jquery2.default)(this).attr("oId");
				...
				// 改签按钮(临时)
				(0, _jquery2.default)(".endorse").off().on("click", function (e) {
					e.stopPropagation();
					e.preventDefault();
					var orderId = (0, _jquery2.default)(this).attr("oId");
			...
			key: 'Deles',
			value: function Deles(num, sta, real, formPop, orderid) {
				var _this = this;
				var order_type = _global2.default.GetUrlPara('order_type');
				var penalty_remarks = (0, _jquery2.default)("#popup-info .pop_bg .tions").val();
				var money = (0, _jquery2.default)("#popup-info .pop_bg .wy_mon").val();
				var pop = _global2.default.Popup.Confirm('是否确认取消此订单！', function () {
					_global2.default.Ajax({
						url: '/Order/cancel',
						type: 'post',
						data: {
			...
			value: function Event() {
				...
				if (order_type) {
					if (order_type == 'buyer') {
						(0, _jquery2.default)('.buyer').show();
						(0, _jquery2.default)('.list-name').html('买家订单');
					} else {

						(0, _jquery2.default)('.seller').show();
						(0, _jquery2.default)('.list-name').html('卖家订单');
					}
				} else {
					(0, _jquery2.default)('.list-name').html('订单列表');
				}
				...
				(0, _jquery2.default)(".t-bar .right").on("click", function () {
				...
				(0, _jquery2.default)(".infor-bar ul").width(nums);
			}
			//  下拉加载数据列表
					...
					if (scrollTop + windowHeight == scrollHeight) {
						...
						if (_this.pages.total > _this.pages.count * 20) {
							if (!(0, _jquery2.default)('body').hasClass('scrolling')) {
								_this.Render(++_this.pages.count);
								(0, _jquery2.default)(".lists").append('<div class="loading">加载中...</div>');
							}
						} else {
							(0, _jquery2.default)(".loading").remove();
						}
