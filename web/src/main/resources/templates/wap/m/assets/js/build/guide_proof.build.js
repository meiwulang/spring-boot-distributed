	...
	var Index = function () {
	    ...
	    (0, _createClass3.default)(Index, [{
	        ...
	        value: function Show() {
	            ...
	            var siid = (0, _jquery2.default)("#mysele").children('option:selected').val();
	            _global2.default.Ajax({
	                ...
	                success: function success(res) {
	                    if (res.code == '200') {
	                        var html = (0, _artTemplate2.default)('tpl-conditions', res);
	                        (0, _jquery2.default)(".phon_uls").html(html);
	                        (0, _jquery2.default)(".pro_rig").html('当前(' + res.total + '张)');
	                        if (res.total == 0) {
	                            (0, _jquery2.default)(".comp").css("display", "none");
	                        }
	                        _this.Event();
	                        _this.BigImg();
	                    }
	            ...
	            _global2.default.Ajax({
	                ...
	                success: function success(res) {
	                    if (res.code == '200') {
	                        ...
	                        (0, _jquery2.default)(".mainse").append(html);
	                        _this.Show();
	                    }
	                }
	            });
	        ...
	        value: function Event() {
	            var _this = this;
	            (0, _jquery2.default)(".del").css("display", "");
	            (0, _jquery2.default)(".clee").css("display", "");
	            (0, _jquery2.default)(".len").find(".sc").remove();
	            //返回
	            (0, _jquery2.default)(".boot .nos").off().on("click", function () {
	                _this.Show();
	                (0, _jquery2.default)(".upsed").removeClass("in");
	            });
	            (0, _jquery2.default)(".upse").on("click", function () {
	                (0, _jquery2.default)(".del").css("display", "");
	                (0, _jquery2.default)(".comp").css("display", "");
	                (0, _jquery2.default)(".clee").css("display", "");
	                (0, _jquery2.default)(".len").find(".sc").remove();
	                (0, _jquery2.default)('.upsed .phon_ul .lis').remove();
	                (0, _jquery2.default)(".upsed").addClass("in");
	            });
	            (0, _jquery2.default)(".lefs").off().on("click", function () {
	                _this.Show();
	                (0, _jquery2.default)(".upsed").removeClass("in");
	            });
	            //返回上一页
	            ...
	            //切换展示凭证
	            (0, _jquery2.default)("#mysele").off().change(function () {
	                (0, _jquery2.default)(".del").css("display", "");
	                (0, _jquery2.default)(".comp").css("display", "");
	                (0, _jquery2.default)(".clee").css("display", "");
	                var siid = (0, _jquery2.default)("#mysele").children('option:selected').val();
	                (0, _jquery2.default)(".upsed select option").each(function () {
	                    if ((0, _jquery2.default)(this).val() == siid) {
	                        (0, _jquery2.default)(this).prop("selected", true);
	                    }
	                });
	                _this.Show();
	            });
	            //编辑删除
	            (0, _jquery2.default)(".comp").off().on("click", function () {
	                (0, _jquery2.default)(".comp").css("display", "none");
	                (0, _jquery2.default)(".clee").css("display", "block");
	                (0, _jquery2.default)(".len").prepend('<div class="sc"></div>');
	                _this.Sc();
	            });
	            //取消编辑
	            (0, _jquery2.default)(".clee").off().on("click", function () {
	                (0, _jquery2.default)(".del").css("display", "");
	                (0, _jquery2.default)(".comp").css("display", "");
	                (0, _jquery2.default)(".clee").css("display", "");
	                (0, _jquery2.default)(".len").find(".sc").remove();
	            ...
	            //照片高度
	            var wid = (0, _jquery2.default)(".len").css("width");
	            (0, _jquery2.default)(".len").css("height", wid);
	            //图片剪切
	            var wh = (0, _jquery2.default)(".len").height();
	            (0, _jquery2.default)(".len img").each(function () {
	                var imgs = (0, _jquery2.default)(this).attr("src");
	                (0, _jquery2.default)(this).attr("src", imgs + '?x-oss-process=image/resize,m_fill,h_' + wh + ',w_' + wh);
	            });
	        }
	    }, {
	        key: 'BigImg',
	        value: function BigImg() {
	            (0, _jquery2.default)('.phon_uls li').on('click', function () {
	                var list = [];
	                var ind = (0, _jquery2.default)(this).index();
	                (0, _jquery2.default)('.phon_uls li').each(function () {
	                    var src = (0, _jquery2.default)(this).find('img').attr('d-src');
	                    list.push(src);
	                });
	                var data = {
	                    list: list
	                };
	                var html = (0, _artTemplate2.default)('tpl-bigimg', data);
	                var $html = (0, _jquery2.default)(html).appendTo('body');
	                ...
	                $html.find('.close').on('click', function () {
	                    (0, _jquery2.default)('#bigimg').remove();
	                });
	            });
	        }
	    }, {
	        ...
	        value: function Sc() {
	            var _this = this;
	            //删除凭证
	            (0, _jquery2.default)(".main .len").off().on("click", function () {
	                if ((0, _jquery2.default)(this).find(".sc")) {
	                    (0, _jquery2.default)(this).find(".sc").toggleClass("scs");
	                    _this.Dele();
	                    var len = (0, _jquery2.default)(".scs").length;
	                    if (len > 0) {
	                        (0, _jquery2.default)(".del").css("display", "block");
	                    } else {
	                        (0, _jquery2.default)(".del").css("display", "");
	                    }
	                }
	        ...
	        value: function Dele() {
	            var _this = this;
	            (0, _jquery2.default)(".del").off().on("click", function () {
	                var data = {
	                    at_id: []
	                };
	                (0, _jquery2.default)(".len").each(function () {
	                    if ((0, _jquery2.default)(this).find(".sc").hasClass("scs")) {
	                        var lid = (0, _jquery2.default)(this).attr("lid");
	                        data['at_id'].push(lid);
	                    }
	                });
	                _global2.default.Popup.Confirm('是否确定删除凭证！', function () {
	                    _global2.default.Ajax({
