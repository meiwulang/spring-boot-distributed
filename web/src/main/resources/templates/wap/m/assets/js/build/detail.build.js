	...
	var Index = function () {
	    function Index() {
	        ...
	        _global2.default.GetCityCode(function (citycode) {
	            ...
	            var openId = _jquery2.default.trim(_global2.default.GetUrlPara('openId'));
	            if (openId) {
	    ...
	    (0, _createClass3.default)(Index, [{
	        key: 'Render',
	        value: function Render(city_code) {
	            var _this = this;
	            var uid = '';
	            var froms = ''; //预览参数
	            //仅浏览 不可操作
	            var from = _global2.default.GetUrlParaByHref("from");
	            if (from == 'preview') {
	                froms = "preview";
	            ...
	            _global2.default.Ajax({
	                ...
	                success: function success(res) {
	                    if (res.code == 200) {
	                        ...
	                        (0, _jquery2.default)("dt span").each(function () {
	                            var html = (0, _jquery2.default)(this).text().replace(/\[@([^\]]*)]/g, ' <i class="fa fa-$1" aria-hidden="true"></i> ');
	                            (0, _jquery2.default)(this).html(html);
	                        });
	                        var appoint = res.data.appoint;
	                        if (appoint == false) {
	                            (0, _jquery2.default)('.date-list li').addClass("appoin");
	                            (0, _jquery2.default)(".submit-btn").attr("href", "javascript:;");
	                            (0, _jquery2.default)(".submit-btn").css("background", "#999");
	                            (0, _jquery2.default)(".submit-btn").html("无权购买");
	                            (0, _jquery2.default)(".submit-btn").addClass("appoin");
	                            (0, _jquery2.default)(".date-t-more").addClass("appoin");
	                        }
	                        var nums = 0;
	                        (0, _jquery2.default)(".details-menu .ul_ul ul li").each(function () {
	                            nums += (0, _jquery2.default)(this).width();
	                        });
	                        (0, _jquery2.default)(".details-menu .ul_ul ul").width(nums);

	                        if ((0, _jquery2.default)(".date-list ul li").length < 1 || res.data.bus_list.no_price_bool == 0) {
	                            (0, _jquery2.default)(".date-t-more").addClass("alerts").attr("href", "javascript:;");
	                            (0, _jquery2.default)(".submit-btn").addClass("alerts").attr("href", "javascript:;");
	                            (0, _jquery2.default)(".date-list").css("display", "none");
	                            (0, _jquery2.default)(".date-t").css("border-bottom", "none");
	                        } else {
	                            (0, _jquery2.default)(".date-list").css("display", "");
	                            (0, _jquery2.default)(".date-t").css("border-bottom", "");
	                        }
	                        _this.Banner();
	                        _this.Event();
	                        ...
	                        if (res.data.detail) {
	                            (0, _jquery2.default)(window).on("scroll", function () {
	                                var $top = (0, _jquery2.default)(window).scrollTop() + 63;
	                                var $off_top = (0, _jquery2.default)("#lifeature").offset().top; //线路特色
	                                var $off_topt = (0, _jquery2.default)("#listroke").offset().top; //行程简介
	                                var $off_topi = (0, _jquery2.default)("#linotice").offset().top; //预定须知
	                                var $off_topg = (0, _jquery2.default)("#livisa").offset().top; //签证信息
	                                var header = document.querySelector('.ul_ul');
	                                if ($top > $off_topt) {
	                                    header.classList.add('sticky');
	                                    (0, _jquery2.default)(".details-menus li").removeClass("active");
	                                    (0, _jquery2.default)(".details-menus li").eq(0).addClass("active");
	                                } else {
	                                    header.classList.remove('sticky');
	                                }
	                                if ($top > $off_top) {
	                                    (0, _jquery2.default)(".details-menus li").removeClass("active");
	                                    (0, _jquery2.default)(".details-menus li").eq(1).addClass("active");
	                                }
	                                if (res.data.detail.cost_in || res.data.detail.cost_noin) {
	                                    var $off_tops = (0, _jquery2.default)("#licost_in").offset().top; //费用包含
	                                    var $off_topf = (0, _jquery2.default)("#licost_noin").offset().top; //费用不包含
	                                    if ($top > $off_tops) {
	                                        (0, _jquery2.default)(".details-menus li").removeClass("active");
	                                        (0, _jquery2.default)(".details-menus li").eq(2).addClass("active");
	                                    }
	                                    if ($top > $off_topf) {
	                                        (0, _jquery2.default)(".details-menus li").removeClass("active");
	                                        (0, _jquery2.default)(".details-menus li").eq(3).addClass("active");
	                                    }
	                                }
	                                if ($top > $off_topi) {
	                                    (0, _jquery2.default)(".details-menus li").removeClass("active");
	                                    (0, _jquery2.default)(".details-menus li").eq(4).addClass("active");
	                                }
	                                if ($top > $off_topg) {
	                                    (0, _jquery2.default)(".details-menus li").removeClass("active");
	                                    (0, _jquery2.default)(".details-menus li").eq(5).addClass("active");
	                                }
	                                //简易、详细行程悬浮
	                                if ($top > $off_topt - 300) {
	                                    (0, _jquery2.default)(".detail_move").show();
	                                } else {
	                                    (0, _jquery2.default)(".detail_move").hide();
	                                }
	                                if ($top > $off_top - 370) {
	                                    (0, _jquery2.default)(".detail_move").hide();
	                                }
	        ...
	        key: 'Wx',
	        value: function Wx(data) {
	            var _this = this;
	            var p_sname = '';
	            // if( data.share_user_flag == 1 ){
	            var uid = '',
	                userinfo_orgid = '';
	            if ((0, _typeof3.default)(data.share_user.u_id)) {
	            ...
	            var oid = _global2.default.GetUrlParaByHref('oid');
	            ...
	            // }
	            //改变title值
	            (0, _jquery2.default)(document).attr("title", data.p_type_name);
	        }
	    }, {
	        key: 'Poes',
	        value: function Poes(urls) {
	            if (urls) {
	                (0, _jquery2.default)(".cops").css("display", "block");
	            }
	            (0, _jquery2.default)(".cops").on("click", function () {
	                ...
	                (0, _jquery2.default)("#popup-mask").css('background-color', 'rgba(0,0,0,0.5)');

	                (0, _jquery2.default)("#popup #popup-mask").on("click", function () {
	        ...
	        value: function Banner() {
	            ...
	            var w = (0, _jquery2.default)('#wrap').width();
	            (0, _jquery2.default)('.banner').height(w * 0.52);
	        }
	    }, {
	        key: 'Event',
	        value: function Event() {
	            ...
	            (0, _jquery2.default)(".appoin").on("click", function () {
	                _global2.default.Popup.Tip('无权购买此产品！');
	                return false;
	            });
	            (0, _jquery2.default)(".alerts").on("click", function () {
	                _global2.default.Popup.Tip('该产品暂无班期');
	            });
	            (0, _jquery2.default)('.date-list li.no-price').on('click', function () {
	                _global2.default.Popup.Tip('该日期暂无票价');
	            });
	            //出发城市
	            (0, _jquery2.default)('.city-check').on('click', function () {
	                var numb = (0, _jquery2.default)(".city_num").text();
	                numb = parseInt(numb);
	                if (numb == 0) {
	                    _global2.default.Popup.Tip('暂无更多城市！');
	                    return false;
	                } else {
	                    (0, _jquery2.default)('.city-list').addClass('in');
	                }
	            });
	            (0, _jquery2.default)('.city-list').on('click', function () {
	                (0, _jquery2.default)(this).removeClass('in');
	            });
	            //活动
	            (0, _jquery2.default)('.promotion-check').on('click', function () {
	                (0, _jquery2.default)('.activi').addClass('in');
	            });
	            (0, _jquery2.default)('.bg_ing,.dei').on('click', function () {
	                (0, _jquery2.default)('.stroke_detail').removeClass('in');
	                (0, _jquery2.default)(".dei").hide();
	            });
	            //查看详情
	            (0, _jquery2.default)('.details-more,.deil').on('click', function () {
	                (0, _jquery2.default)('.stroke_detail').addClass('in');
	                (0, _jquery2.default)(".dei").show();
	            });
	            if (_uinfo && _uinfo.u_stype) {
	                if (_uinfo.u_stype == '3') {
	                    (0, _jquery2.default)(".icons .back").hide();
	                }
	            }
	            //查看同行价
	            (0, _jquery2.default)(".eye").on("click", function () {
	                (0, _jquery2.default)(this).toggleClass('eyes');
	                // $('.priced').toggleClass('dis_no');
	                // $(".mation").toggleClass("dise");
	                // $(".detail_play").toggleClass("die");
	                if ((0, _jquery2.default)(this).hasClass('eyes')) {
	            ...
	            (0, _jquery2.default)('.city-list li').off().on('click', function (e) {
	                e.stopPropagation();
	                //判断是否为已选城市
	                if ((0, _jquery2.default)(this).hasClass("colors")) {
	                    return false;
	                }
	                var code = (0, _jquery2.default)(this).attr('code'),
	                    name = (0, _jquery2.default)(this).text();
	                (0, _jquery2.default)('.city-active').text(name).attr('code', code);
	                (0, _jquery2.default)('.city-list').removeClass('in');
	                var city_code = (0, _jquery2.default)('.city-active').attr('code'),
	                    city_name = (0, _jquery2.default)('.city-active').text();
	                (0, _jquery2.default)(this).addClass('colors').siblings().removeClass('colors');
	                _global2.default.Cookie.Add('city_code', city_code);
	                _global2.default.Cookie.Add('city_name', city_name);
	                _this.Render(city_code);
	            });
	            //天数锚点动画
	            (0, _jquery2.default)('.attrli li a').on("click", function () {
	                (0, _jquery2.default)("html, body").animate({
	                    scrollTop: (0, _jquery2.default)((0, _jquery2.default)(this).attr("href")).offset().top + -50 + "px"
	                }, {
	                    duration: 500,
	                    easing: "swing"
	                });
	            ...
	            if (_uinfo && _uinfo.u_id) {
	                ...
	                // }
	                //过滤行程没有图片
	            (0, _jquery2.default)(".img-list").each(function () {
	                var len = (0, _jquery2.default)(this).find(".i-detail img").length;
	                if (len < 1) {
	                    (0, _jquery2.default)(this).remove();
	                }
	            });
	            if (share_user && share_user.u_id) {
	                (0, _jquery2.default)(".date-list ul li a").each(function () {
	                    var hre = (0, _jquery2.default)(this).attr("href");
	                    var hr = hre + '&u_id=' + share_user.u_id;
	                    (0, _jquery2.default)(this).attr("href", hr);
	                });
	                var hrefs = (0, _jquery2.default)(".submit-btn").attr("href");
	                (0, _jquery2.default)(".submit-btn").attr("href", hrefs + "&u_id=" + share_user.u_id);
	            }
	        }
	    }]);
	    return Index;
