...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Index = function () {
	    ...
	    (0, _createClass3.default)(Index, [{
	        key: 'GetPara',
	        value: function GetPara() {
	            var team_id = _global2.default.GetUrlPara('team_id'),
	                type = decodeURIComponent(_global2.default.GetUrlPara('type')),
	                cate = decodeURIComponent(_global2.default.GetUrlPara('cate')),
	                action = _global2.default.GetUrlPara('action'),
	                tpi_id = _global2.default.GetUrlPara('tpi_id');
	            return {
	                team_id: team_id,
	                type: type,
	                cate: cate,
	        ...
	        value: function Cate() {
	            var _this = this;
	            var type = _this.GetPara().type;
	            var action = _this.GetPara().action;
	            var team_id = _global2.default.GetUrlPara('team_id');
	            (0, _jquery2.default)(".titl").html(type);
	                    ...
	                    if (res.code == 200 && res.data) {
	                        ...
	                        if (action == 'add') {
	                            ...
	                            _global2.default.Ajax({
	                                ...
	                                success: function success(res) {
	                                    if (res.code == 200) {
	                                        data = _jquery2.default.extend(data, { data: res.data });
	                                        _this.Render(data);
	                                    }
	                                }
	                            });
	        ...
	        value: function Render(data) {
	            var _this = this;
	            var html = (0, _artTemplate2.default)('tpl-write', data);
	            (0, _jquery2.default)('.pen .cons').html(html);
	            var ind = (0, _jquery2.default)('.ban li.active').parents('.swiper-slide').index();
	        ...
	        value: function Event() {
	            var _this = this;
	            var UrlPara = _this.GetPara();
	            (0, _jquery2.default)('.acti_header a.bg_ing,.nos').on('click', function () {
	                window.location.href = 'guide_team.html?id=' + UrlPara.team_id + '&type=' + UrlPara.type + '&cate=' + UrlPara.cate;
	            });

	            (0, _jquery2.default)('.boot .yes').on('click', function () {
	                _this.Save();
	            });
	        }
	    }, {
	        ...
	        value: function RenderEvent() {
	            ...
	            (0, _jquery2.default)('.settle_type select').on('change', function () {
	                var $ul = (0, _jquery2.default)(this).parents('ul');
	                var v = (0, _jquery2.default)(this).val();
	                if (v == '签单') {
	            ...
	            var cate = _this.GetPara().cate;
	            if (cate == '购物店') {
	                (0, _jquery2.default)('.tpi_price input,.tpi_percent input,.tpi_num input,.tpi_money input').on('keyup', function () {
	                    var price = 0,
	                        percent = 0,
	                        num = 0,
	                        money = 0,
	                        reback = 0;
	                    var tes = (0, _jquery2.default)('.tpi_price input').val();
	                    if (tes) {
	                        tes = tes.replace(/[^\d^\.]+/g, "");
	                        (0, _jquery2.default)('.tpi_price input').val(tes);
	                    }

	                    var per = (0, _jquery2.default)('.tpi_percent input').val();
	                    if (per) {
	                        per = per.replace(/[^\d^\.]+/g, "");
	                        (0, _jquery2.default)('.tpi_percent input').val(per);
	                    }

	                    var nu = (0, _jquery2.default)('.tpi_num input').val();
	                    if (nu) {
	                        nu = nu.replace(/[^\d^\.]+/g, "");
	                        (0, _jquery2.default)('.tpi_num input').val(nu);
	                    }

	                    var mon = (0, _jquery2.default)('.tpi_money input').val();
	                    if (mon) {
	                        mon = mon.replace(/[^\d^\.]+/g, "");
	                        (0, _jquery2.default)('.tpi_money input').val(mon);
	                    }

	                    if ((0, _jquery2.default)('.tpi_price input').val()) {
	                        price = parseFloat((0, _jquery2.default)('.tpi_price input').val());
	                    }

	                    if ((0, _jquery2.default)('.tpi_percent input').val()) {
	                        percent = parseFloat((0, _jquery2.default)('.tpi_percent input').val());
	                    }

	                    if ((0, _jquery2.default)('.tpi_num input').val()) {
	                        num = parseFloat((0, _jquery2.default)('.tpi_num input').val());
	                    }

	                    if ((0, _jquery2.default)('.tpi_money input').val()) {
	                        money = parseFloat((0, _jquery2.default)('.tpi_money input').val());
	                    }

	                    reback = (price * num + money * percent / 100).toFixed(2);
	                    // 计算项目：返佣总额不可编辑（=人头单位*进店人数+购物总额*流水比例/100）

	                    (0, _jquery2.default)('.tpi_reback input').val(reback);
	                });
	            } else {
	                (0, _jquery2.default)('.tpi_price input,.tpi_num input').on('keyup', function () {
	                    var mon = (0, _jquery2.default)('.tpi_price input').val();
	                    if (mon) {
	                        mon = mon.replace(/[^\d^\.]+/g, "");
	                        (0, _jquery2.default)('.tpi_price input').val(mon);
	                    }

	                    var mons = (0, _jquery2.default)('.tpi_num input').val();
	                    if (mons) {
	                        mons = mons.replace(/[^\d^\.]+/g, "");
	                        (0, _jquery2.default)('.tpi_num input').val(mons);
	                    }
	                    var price = parseFloat((0, _jquery2.default)('.tpi_price input').val()),
	                        num = parseFloat((0, _jquery2.default)('.tpi_num input').val()),
	                        money = 0;
	                    if (price && num) {
	                        money = (_jquery2.default.trim(price) * _jquery2.default.trim(num)).toFixed(2);
	                        // 计算项目：（单价*数量）
	                    }
	                    (0, _jquery2.default)('.tpi_money input').val(money);
	                });
	            }
	        }
	    }, {
	        ...
	        value: function Save() {
	            ...
	            if (cate == '购物店') {
	                var tpi_date = (0, _jquery2.default)('.tpi_date input').val(),

	                // 进店日期
	                tpi_name = (0, _jquery2.default)('.tpi_name input').val(),

	                // 购物店
	                tpi_spec = (0, _jquery2.default)('.tpi_spec input').val(),

	                // 项目规格
	                settle_type = (0, _jquery2.default)('.settle_type select').val(),

	                // 结算类型
	                settle_number = (0, _jquery2.default)('.settle_number input').val(),

	                // 签单号
	                tpi_price = (0, _jquery2.default)('.tpi_price input').val(),

	                // 人头单价
	                tpi_percent = (0, _jquery2.default)('.tpi_percent input').val(),

	                // 流水比例
	                tpi_num = (0, _jquery2.default)('.tpi_num input').val(),

	                // 进店人数
	                tpi_money = (0, _jquery2.default)('.tpi_money input').val(),

	                // 购物总额
	                tpi_reback = (0, _jquery2.default)('.tpi_reback input').val(),

	                // 返佣总额
	                tpi_remark = (0, _jquery2.default)('.tpi_remark input').val();
	                // 备注

	                if (!tpi_name) {
	                    _global2.default.Popup.Tip('请填写购物店');
	                    return false;
	                }
	                ...
	                if ((!tpi_num || !tpi_price) && (!tpi_percent || !tpi_money)) {
	                    _global2.default.Popup.Tip('人头费和购物提成至少填写一组');
	                    return false;
	                }
	                ...
	                if (!tpi_name) {
	                    _global2.default.Popup.Tip('请填写项目名称');
	                    return false;
	                }
	                ...
	                if (!tpi_price) {
	                    _global2.default.Popup.Tip('请填写单价');
	                    return false;
	                }

	                if (!tpi_num) {
	                    _global2.default.Popup.Tip('请填写数量');
	                    return false;
	                }
	            ...
	            var pop = _global2.default.Popup.Confirm('是否确定保存项目详细', function () {
	                _global2.default.Ajax({
	                    ...
	                    success: function success(res) {
	                        ...
	                        if (res.code == 200) {
	                            pop.remove();
	                            _global2.default.Popup.Tip('保存成功');
