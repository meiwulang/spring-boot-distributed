	...
	var Index = function () {
	    ...
	    (0, _createClass3.default)(Index, [{
	        ...
	        value: function Event() {
	            (0, _jquery2.default)('.order').on("click", function () {
	                if ((0, _jquery2.default)('a.order').find('i.fa-credit-card')) {
	                    window.location.href = "buyer_order.html?" + "order_type=buyer";
	                } else {
	                    // window.location.href = ".html?" + "order_type=buyer";
	                }
	            });
	        }
	    }]);
