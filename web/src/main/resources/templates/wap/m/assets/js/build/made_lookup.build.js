	...
	var Index = function () {
	  ...
	  (0, _createClass3.default)(Index, [{
	    ...
	    value: function Render() {
	      var dId = _global2.default.GetUrlPara('id');
	      var status = _global2.default.GetUrlPara('status');
	      var _this = this;
	      _global2.default.Ajax({
	        ...
	        success: function success(res) {
	          if (res.code == "200") {
	            res['status'] = status;
	            var html = (0, _artTemplate2.default)('tpl-citylist', res);
	            (0, _jquery2.default)('.look').html(html);
	          }
	        }
	      });
	    }
