...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Index = function () {
		function Index() {
			...
			var _this = this;
			if (_guide.g_mob || _uinfo && _uinfo.u_id) {} else {
		...
		(0, _createClass3.default)(Index, [{
					...
					success: function success(res) {
						if (res.code == 200) {
							...
							if (res.data.team_detail.team_credit_status != '未报账') {
								console.log(1212);
								(0, _jquery2.default)(".nav_three").removeClass("nav_th");
								(0, _jquery2.default)(".nav_three a").html((0, _jquery2.default)(".sons").html());
							}
							...
							if (u_mobile == res.data.team_detail.team_local_guide_tel || g_mob == res.data.team_detail.team_local_guide_tel) {} else {
								(0, _jquery2.default)(".nav_three").removeClass("nav_th");
							}
							_this.Event();
						}
			...
			value: function Event() {
				var _this = this;
				(0, _jquery2.default)(".nav_th").off().on("click", function () {
					_global2.default.Popup.Confirm('是否确定提交报账！', function () {
						var id = _global2.default.GetUrlPara('id');
