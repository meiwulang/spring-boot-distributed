Ext.onReady(function () {
    ...
    Ext.QuickTips.init();
    var thisTitle = '供应商活跃度';
    var url = $__app__ + '/ActivitySupplier/getListData';
    var field = [];
    ...
    //有供应商的省份、城市列表
    var area_url = $__app__ + '/ActivitySupplier/getAreaList';
    var area_field = [];
    ...
    function doExcel(){
        ...
        window.location = $__app__+'/ActivitySupplier/getlistDataExcel?'+url;
    }
