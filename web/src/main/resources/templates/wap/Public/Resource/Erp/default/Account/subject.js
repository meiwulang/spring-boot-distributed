...
Ext.onReady(function(){
    ...
    var _url=$__app__+'/Account/subject_data';
    ...
    SUNLINE.baseParams(_store, {'as_category':_default_category, limit:9999});
    ...
    function get_subject_data(b){
        _default_category = b.text;
        SUNLINE.baseParams(_store, {'as_category': _default_category});
        _store.load();
    };
    ...
    function do_save(b){
        ...
        _real_save(_fv, _f, _win);
    };

    function _real_save(data, form, win){
        if (!data) {
        ...
        myMask.show();
        Ext.Ajax.request({
            url: $__app__+'/Account/subject_save',
            params: data,
            method:'POST',
