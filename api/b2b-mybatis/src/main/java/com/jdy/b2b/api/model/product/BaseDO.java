...
public class BaseDO {
	...
	protected transient Integer puDataLimit;
	protected transient Long pcompanyId;// 用户所属公司id
	protected transient Long puDepartmentId;// 部门id
	protected transient List<Long> puDepartmentIds;// 子部门id集合

	public List<Long> getPuDepartmentIds() {
		return puDepartmentIds;
	}

	public void setPuDepartmentIds(List<Long> puDepartmentIds) {
		this.puDepartmentIds = puDepartmentIds;
	}
