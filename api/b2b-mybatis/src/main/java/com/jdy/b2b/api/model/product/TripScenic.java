...
public class TripScenic extends BaseDO {
	private Long id;

	private Long phTripId;

	private Long phScenicId;
	private Long phPid;
	...
	public Long getPhScenicId() {
		return phScenicId;
	}

	public void setPhScenicId(Long phScenicId) {
		this.phScenicId = phScenicId;
	}
