...
public class BeanUtils {
	...
	public static void copyProperties(Object source, Object target, String[] properties, boolean convertType, boolean ignoreNullValue) {
		Map valueMap = getProperties(source, properties, false);
	...
	public static Map getProperties(Object obj) {
		...
		return getProperties(obj, propertiyNames, false);
	}

	/**
	 * 对象转换为Map
	 * @param obj
	 * @param ingoreKey 忽略的数组
	 * @return
	 */
	public static Map getProperties(Object obj,String[] ingoreKey) {
		String[] propertiyNames = getPropertyNames(obj);
		propertiyNames = arrContrast(propertiyNames,ingoreKey);
		return getProperties(obj, propertiyNames, false);
	}
